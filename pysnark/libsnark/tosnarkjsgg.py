...
print('{', file=vkout)
print(' "protocol": "groth16",', file=vkout)
print(' "curve": "bn128",', file=vkout)
...
def process_g2(nm, fin, fout, skipcomma=False):
    ...
    print('   [ "' + a3[0] + '", "' + a3[1] + '"] ]' + ('' if skipcomma else ','), file=fout)
...
print(' "vk_alphabeta_12": [', file=vkout)
print('   [', file=vkout)
...
process_g1("vk_alpha_1", vkin, vkout)
